// /assets/js/producto-accesorios.js
...
/* =============== FUNCION PRINCIPAL =================== */
function cargarProductoAccesorios() {
  ...
  // producto
  const producto = obtenerProducto('accesorios', idProducto);
  if(!producto) {
...
function renderBreadcrumb(producto) {
  ...
  const breadcrumbHtml = `
    ...
    <li class="breadcrumb-item"><a href="${window.BASE_URL}pages/accesorios.html">Accesorios</a></li>
